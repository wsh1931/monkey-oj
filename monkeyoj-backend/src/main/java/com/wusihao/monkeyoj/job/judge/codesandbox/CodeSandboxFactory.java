...
import com.wusihao.monkeyoj.job.judge.codesandbox.impl.RemoteSandboxImpl;
import com.wusihao.monkeyoj.job.judge.codesandbox.impl.ThirdPartySandboxImpl;
...
public class CodeSandboxFactory {
     ...
     * @date 2025/1/2 14:35
     */
    public static com.wusihao.monkeyoj.job.judge.codesandbox.CodeSandbox newInstance(String type) {
        switch (type) {
            case "example":
