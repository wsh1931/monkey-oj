...
import com.yupi.monkeyoj.model.dto.question.QuestionQueryRequest;
import com.yupi.monkeyoj.model.entity.Question;
import com.yupi.monkeyoj.model.entity.User;
import com.yupi.monkeyoj.model.vo.QuestionVO;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        // 创建时，参数不能为空, 若title, content, tags中有一个为空则抛出异常
        if (add) {
